...
export default function ProjectDetails() {
  ...
  const project = {
    id: 1,
    title: "نظام إدارة المرضى باستخدام الذكاء الاصطنا��ي",
    description: `تطبيق ويب متكامل لإدارة بيانات المرضى وحجز المواعيد باستخدام خوارزميات التعلم الآلي لتحسين كفاءة الخدمات الطبية. يهدف المشروع إلى تحسين تجربة المرضى والأطباء من خلال توفير واجهة حديثة وسهلة الاستخدام، مع إمكانيات بحث ذكية وتوصيات شخصية للعلاج.

يتضمن النظام ميزات متقدمة مثل إدارة المواعيد بالذكاء الاصطناعي، نظام تشخيص مساعد، وتحليلات مفصلة لبيانات المرضى. كما يدعم النظام تقنيات التحليل الطبي لمساعدة الأطباء في اتخاذ قرارات أفضل.`,
    author: "سليمان يوسف",
